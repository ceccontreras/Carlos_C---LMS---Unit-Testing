...
public class Library {
    ...
    /**
     * getBookByTitle method retrieves a book from the collection using its title.
     *
    ...
    // New addBook method to add a single book to the library
    /**
     * addBook method adds a single book to the collection.
     *
     * @param book The book to add to the library collection.
     */
    ...
    public int size() {
        return books.size();  // Return the number of books in the collection
    }
